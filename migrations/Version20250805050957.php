 ...
 */
final class Version20250805050957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarea DROP titulo, DROP descripcion');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarea ADD titulo VARCHAR(255) DEFAULT NULL, ADD descripcion LONGTEXT DEFAULT NULL');
    }
}
